...
cps_pov <-
  ...
  .[j = faminc_adj_unbounded := faminc_draw - ifelse(eip1_receipt, eip1_est, 0) -
                                              ifelse(eip2_receipt, eip2_est, 0) -
                                              ifelse(eip3_receipt, eip3_est, 0)] %>% 
  ...
  .[j = `:=`(
             ...
             fam_incpov_ratio_le1.30_adj = 1*(fam_incpov_ratio_adj <= 1.30),
...
cps_child_base <- 
  ...
  .[j = c("CPSID", "CPSIDP", "WTFINL", "HWTFINL", 
          ...
          "fam_incpov_ratio_cat_by130",   "fam_incpov_ratio_cat_by130_adj",
