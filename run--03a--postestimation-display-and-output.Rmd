...
nowcast_parallel_incpov_018_le130_205 <-
  nowcast_parallel_setup %>%
  filter(
    str_detect(outcome_var, "bIncpov_le(130|205)"),
  ...
  mutate(
    base_share = 
      case_when(
        outcome_var == "bIncpov_le130" ~ share_0_75 + share_75_130,
        outcome_var == "bIncpov_le205" ~ share_0_75 + share_75_130 + share_130_200
      )
  )

nowcast_parallel_incpov_1964_le130_138 <- 
  nowcast_parallel_setup %>% 
  filter(
    str_detect(outcome_var, "bIncpov_le(130|138)"),
    str_detect(sae_spec, "inc$"),
    str_detect(age, "Age(19to25|26to44|45to64)")
  ) %>% 
  mutate(
