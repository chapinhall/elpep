...
cbind(
  sae_results_019_inc[["agg_comp_fh"]]$agg_comp_cor        %>% mutate(Age0to19  = r3(V1)) %>% select(-V1),
  sae_results_2064_inc[["agg_comp_fh"]]$agg_comp_cor       %>% mutate(Age20to64 = r3(V1)) %>% select(Age20to64)
...
cbind(
  sae_results_019_inc[["agg_comp_model"]]$agg_comp_cor        %>% mutate(Age0to19  = r3(V1)) %>% select(-V1),
  sae_results_2064_inc[["agg_comp_model"]]$agg_comp_cor       %>% mutate(Age20to64 = r3(V1)) %>% select(Age20to64)
