...
if (base_year <= 2021) {
  xwalk_source <- "http://www2.census.gov/geo/docs/maps-data/data/rel/2010_Census_Tract_to_2010_PUMA.txt"
  ...
  xwalk_source <- "http://www2.census.gov/geo/docs/maps-data/data/rel2020/2020_Census_Tract_to_2020_PUMA.txt"
}
...
geo_crosswalk_zcta <-
  fread("http://www2.census.gov/geo/docs/maps-data/data/rel2020/zcta520/tab20_zcta520_tract20_natl.txt") %>%
...
geo_crosswalk_zcta_2010 <- 
  fread("http://www2.census.gov/geo/docs/maps-data/data/rel/zcta_tract_rel_10.txt") %>%
  .[STATE == my_state_fip] %>% 
...
if (my_state_abbr == "IL") {
  ...
  geo_crosswalk_sd <- 
    geo_crosswalk_sd %>% 
    mutate(school = 
             case_when(school == "Chester-East Lincoln Community CSD 61" ~ "Chester-East Lincoln Community Csd 61",
                       TRUE                                              ~ school))
 
  stopifnot(mean(b5_sd$school %in% geo_crosswalk_sd$school) == 1)
  stopifnot(mean(geo_crosswalk_sd$school %in% b5_sd$school) == 1)
  geo_crosswalk_b5 <- 
    geo_crosswalk_sd %>% 
